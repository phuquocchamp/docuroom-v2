                    ...
                    {[
                        {
                            ...
                            doc: "32 tài liệu",
                            color: "bg-blue-500",
                            imgSrc: "/group/Korean.jpg",
                        },
                        {
                            topic: "Lập trình mạng",
                            doc: "32 tài liệu",
                            color: "bg-orange-500",
                            imgSrc: "/group/LapTrinhMang.jpg",
                        },
                        {
                            topic: "English",
                            doc: "32 tài liệu",
                            color: "bg-green-500",
                            imgSrc: "/group/English.jpg",
                        },
                        {
                        ...
                        >
                            <div className="flex items-center space-x-8">
                                ...
                                <div className="flex-1">
                                    ...
                                    <button className="mt-2 bg-white text-blue-500  px-6 py-2 rounded-full shadow-md hover:bg-blue-100 transition-colors duration-200">
                                        View
                                    </button>{" "}
                        ...
                        <div className="bg-white rounded-lg shadow-md p-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {[
                                    {
                                        group: "VKU",
                                        imgSrc: "/comunity/vku.png",
                                    },
                                    {
                                        group: "DUE",
                                        imgSrc: "/comunity/due.png",
                                    },
                                    {
                                        group: "DUT",
                                        imgSrc: "/comunity/dut.jpg",
                                    },
                                ].map((item, index) => (
                                    <div
                                        key={index}
